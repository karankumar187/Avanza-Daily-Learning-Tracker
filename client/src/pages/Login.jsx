...
const Login = () => {
  ...
  // Silently ping the server on page load so Render wakes up before the user hits login
  useEffect(() => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card rounded-2xl p-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-green-800 font-medium">Welcome back!</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="rounded border-gray-300 w-4 h-4 text-green-800 focus:ring-green-700" />
                <span className="text-gray-600">Remember me</span>
              </label>
              <Link to="#" className="text-green-800 hover:text-green-800 font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/register" className="text-green-800 hover:text-green-800 font-medium">
                Sign up
              </Link>
            </p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="glass-card rounded-xl p-4">
            <div className="text-2xl font-bold text-green-800">AI</div>
